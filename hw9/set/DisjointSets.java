...
public class DisjointSets {
  ...
  public void union(int root1, int root2) {
    if (array[root1] > 0 && array[root2] > 0) {
      System.out.println("Both root1 and root2 are non-root node, can't union.");
      return;
    }

    if (array[root1] > 0 && array[root2] < 0) {
      System.out.println("Root1 is non-root node, can't union.");
      return;
    }

    if (array[root1] < 0 && array[root2] > 0) {
      System.out.println("Root2 is non-root node, can't union.");
      return;
    }
